...
<template>
    <div class="notification-bell-container relative">
        ...
        <button
            ...
            class="relative p-1.5 rounded-full transition-all duration-200"
            :class="isOpen ? 'bg-secondary/20' : 'hover:bg-secondary/10'"
        ...
        <div
            v-if="isOpen"
            class="absolute right-0 w-80 bg-white rounded-xl shadow-lg ring-1 ring-slate-900/10 z-50 overflow-hidden
                   top-full mt-2
